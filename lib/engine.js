...
!function(exports) {
	...
	Reporter.prototype = {
		...
		warn: function(message, entity, severity, rule) {
			this.report(message, entity, severity, rule, 'warning');
		},
	    ...
	    formatResults: function(results, url) {
	        ...
	        if (messages.length > 0) {
	            messages.forEach(function (message, i) {
                    ...
                    output.push("<" + type + " message=\"" + escapeSpecialCharacters(message.message + " Fix: " + message.rule.desc) + "\"><![CDATA[" + 'entity=' + message.entity + ':severity=' + message.severity + "%]]></" + type + ">");
